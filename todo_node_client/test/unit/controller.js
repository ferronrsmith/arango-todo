    ...
    beforeEach(inject(function (_$httpBackend_, $rootScope, $controller) {
        ...
        todols = [
            ...
            },
            {
                ...
                "_key": "50fed0515b327624040005fb"
            }
        ];

        $httpBackend.whenGET('http://localhost:9529/_db/_system/todo/todos').respond(todols);
        $httpBackend.whenDELETE('http://localhost:9529/_db/_system/todo/todos/50feaec65b32762404000516').respond(todols[0]);
        $httpBackend.whenDELETE('http://localhost:9529/_db/_system/todo/todos/50fed0515b327624040005fb').respond(todols[1]);
        $httpBackend.whenPATCH(/http:\/\/localhost:9529\/_db\/_system\/todo\/todos\/(50feaec65b32762404000516|50fed0515b327624040005fb)/).respond(todols[1]);
        $httpBackend.whenPUT('http://localhost:9529/_db/_system/todo/todos/50feaec65b32762404000516').respond(todols[0]);
        $httpBackend.whenPOST('http://localhost:9529/_db/_system/todo/todos', {
            "title" : "something there",
            "completed": false
        }).respond(todols[1]);
